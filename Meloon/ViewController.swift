...
class ViewController: UIViewController {
    ...
    let URL_USER_LOGIN = "http:/localhost/SimplifiediOS/v1/login.php"
        ...
        Alamofire.request(URL_USER_LOGIN, method: .post, parameters: parameters).responseJSON
            {
                ...
                if let result = response.result.value {
                    ...
                    if(!(jsonData.value(forKey: "error") as! Bool)){
                        ...
                        let imageUser = user.value(forKey: "imageUser") as! String
                        ...
                        self.defaultValues.set(imageUser, forKey: "imageUser")
                      ...
                      /*  let tabBarViewController = self.storyboard?.instantiateViewController(withIdentifier: "home") as! tabBarViewController
                        ...
                        let alert = UIAlertController(title: "Notice", message: "Invalid username or password", preferredStyle: .alert)
